...
Two middleware functions are provided by default in the `pronosmondial.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `pronosmondial.handler` namespace to manage the enabled middleware.
